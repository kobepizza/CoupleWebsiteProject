       ...
       <div class="w-full h-screen overflow-hidden relative flex items-center justify-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('ourStory') }}"
                    class="inline-block text-center w-full sm:w-auto bg-white text-emerald-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg">
                    Read our Story
                </a>


                <a href="{{ route('gallery') }}"
                    class="inline-block text-center w-full sm:w-auto bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-pink-500 transition">
                    See the Gallery
                </a>
    </div>
            </div>
          ...
          <div class="py-5">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-7 md:px-12 py-10 gap-10">
                    <div class="w-full md:w-1/2 text-center md:text-left">
                        ...
                        <p class="text-lg text-emerald-50 mb-8 leading-relaxed">
                           It started with a single <span class="font-black text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] italic">'Aswang ka ba?'</span>  and somehow, that actually worked. 
                           Since that day, life has just been better with you around. This is a place for us to keep track of the stuff we’ve done, 
                           the places we’ve been, and all the random moments that make us, us 
                        </p>
                    </div>
            ...
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center justify-between px-6 md:px-12 py-10 gap-10">
                    <div class="w-full md:w-1/2 text-center md:text-left">
                        ...
                        <p class="text-lg text-emerald-50 mb-8 leading-relaxed">
                            We’ve stayed busy. From the big trips to the nights we just stayed in and did nothing, we’re slowly filling up this list. It's not about being perfect; it’s just about looking back and remembering exactly how it felt to be there.
                        </p>
                    </div>
                    <div class="w-full md:w-1/2">
                ...
                <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-7 md:px-12 py-10 gap-10">
                    <div class="w-full md:w-1/2 text-center md:text-left">
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">The Little Things</h2>
                        <p class="text-lg text-emerald-50 mb-8 leading-relaxed">
                           It’s not always about the big vacations or the filtered photos. Most of the time, 
                           it’s just the quiet moments, the inside jokes, and the everyday stuff that makes this worth it. This is a reminder of those times, too.
                        </p>
                    </div>
                    <div class="w-full md:w-1/2">
                        <img src="Images/image2.JPG" alt="Memory" class="w-full h-auto rounded-2xl shadow-2xl object-cover">
            ...
            <!--collage section-->
               ...
               <div class="max-w-4xl mx-auto px-6 text-center mt-20">
                ...
                <div class="hidden md:block relative w-full max-w-6xl mx-auto h-[800px] mt-10">
                    <div class="absolute top-[10%] left-[50%] w-[20%] z-20 hover:z-50 transition-all hover:scale-110">
                        <img src="Images/dinner.jpeg" class="w-full rounded-lg shadow-xl border-4 border-white rotate-[-3deg]">
                    </div>
                    <div class="absolute top-[10%] left-[20%] w-[25%] z-30 transition-all hover:scale-110">
                        <img src="Images/baking.jpg" class="w-full rounded-lg shadow-xl border-4 border-white rotate-[2deg]">
                    </div>
                    ...
                    <div class="absolute bottom-[10%] left-[20%] w-[22%] z-10 hover:z-50 transition-all hover:scale-110">
                        <img src="Images/closeup.JPG" class="w-full rounded-lg shadow-lg border-4 border-white rotate-[-5deg]">
                    </div>
                    <div class="absolute bottom-[5%] left-[60%] w-[28%] z-10 transition-all hover:scale-110">
                        <img src="Images/sipsip.jpeg" class="w-full rounded-lg shadow-lg border-4 border-white rotate-[4deg]">
                    </div>
                </div>
